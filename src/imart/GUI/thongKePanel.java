...
public class thongKePanel {
    ...
    public void sp(){
        ...
        c.setPreferredSize(new Dimension(1530, 800));
        c.setMaximumSize(new Dimension(1530, 800));
        c.setMinimumSize(new Dimension(1530, 800));
        c3.setLayout(new FlowLayout(FlowLayout.RIGHT,10,10));
        c3.setPreferredSize(new Dimension(1530, 60));
        c3.setMaximumSize(new Dimension(1530, 60));
        c3.setMinimumSize(new Dimension(1530, 60));
        
         tong.setPreferredSize(new Dimension(200, 80));
        tong.setMaximumSize(new Dimension(100, 80));
        tong.setMinimumSize(new Dimension(200, 80));
        tong.setFont(new Font("Segoe UI", Font.BOLD,17));
        ...
        tbtk1.setPreferredSize(new Dimension(1500,600));
        tbtk1.setMaximumSize(new Dimension(1500,600));
        tbtk1.setMinimumSize(new Dimension(1500,600));
        tbtk2.setPreferredSize(new Dimension(1500,560));
    ...
    .setHorizontalAlignment(JLabel.LEFT);
        ...
        JButton Xoa=new javax.swing.JButton(){
            ...
            JButton Xoa2=new javax.swing.JButton(){
                @Override
                protected void paintComponent(Graphics g) {
                   super.paintComponent(g);    
                   Dimension arcs = new Dimension(15,15); //Border corners arcs {width,height}, change this to whatever you want
                   ...
                   graphics.setColor(Color.WHITE);
                   graphics.setFont(new Font("Segoe UI", Font.ROMAN_BASELINE,14));
                   graphics.drawString("import File", 40, 25);
                   iconlog.paintIcon(this, g, 18 , 11);
                }
            };
            Xoa2.setPreferredSize(new Dimension(150,40));
            Xoa2.setBorder(null);
            Xoa2.setBackground(Color.WHITE);
   ...
   public void nv(){
        ...
        d.setPreferredSize(new Dimension(1530, 800));
        d.setMaximumSize(new Dimension(1530, 800));
        d.setMinimumSize(new Dimension(1530, 800));
        tong.setPreferredSize(new Dimension(200, 80));
        tong.setMaximumSize(new Dimension(100, 80));
        tong.setMinimumSize(new Dimension(200, 80));
        tong.setFont(new Font("Segoe UI", Font.BOLD,17));
        d3.setLayout(new FlowLayout(FlowLayout.RIGHT,10,10));
        d3.setPreferredSize(new Dimension(1530, 60));
        d3.setMaximumSize(new Dimension(1530, 60));
        d3.setMinimumSize(new Dimension(1530, 60));
        ...
        tbnv1.setPreferredSize(new Dimension(1500,700));
        tbnv1.setMaximumSize(new Dimension(1500,700));
        tbnv1.setMinimumSize(new Dimension(1500,700));
        tbnv2.setPreferredSize(new Dimension(1500,660));
   ...
   /* Thêm vào */
   public void tkdatesp(JTable a,JScrollPane b,JLabel c){
         DefaultTableModel z=new DefaultTableModel(0, 0);
            Object[] ob = new Object[]{"STT","Masp","Loai", "TenSp", "SL Bán", "Doanh Thu"};
            z = new DefaultTableModel(ob, 0);
            int j=0;
            int tong=0;
   ...
   /* Thêm vào */
   public void tkdatenv(JTable a,JLabel b){
         DefaultTableModel z=new DefaultTableModel(0, 0);
            Object[] ob = new Object[]{"STT","Manv","Ho", "Ten", "SL Bán", "Doanh Thu"};
            z = new DefaultTableModel(ob, 0);
            int j=0;
   ...
   public void tkdatekh(JTable a,JLabel b){
         DefaultTableModel z=new DefaultTableModel(0, 0);
            Object[] ob = new Object[]{"STT","Makh","Ho", "Ten", "SL Bán", "Doanh Thu"};
            z = new DefaultTableModel(ob, 0);
            int j=0;
